"""
This is a simple storage for sentences that can be used in the tests.
They are made like this to be stored directly as a list of strings in the tests,
directly importable and usable.

These sentences are divided into two categories: positive and negative.
They are made to be very simple and with clear intent.
